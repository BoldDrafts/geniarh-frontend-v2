...
interface DeleteRecruitmentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  title: string;
...
const DeleteRecruitmentModal: React.FC<DeleteRecruitmentModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  title,
      ...
      <div className="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-lg bg-white">
        ...
        <div className="mb-6">
          <p className="text-sm text-gray-500">
            This action cannot be undone. To confirm deletion, please type <span className="font-medium text-gray-900">{title}</span> below:
          </p>
        </div>
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            disabled={confirmationText !== title}
